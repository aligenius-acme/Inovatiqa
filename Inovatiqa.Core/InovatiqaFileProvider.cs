...
{
    public class InovatiqaFileProvider : PhysicalFileProvider, IInovatiqaFileProvider
    {
        public InovatiqaFileProvider(IWebHostEnvironment webHostEnvironment)
        ...
        {
            return System.IO.Directory.EnumerateFiles(directoryPath, searchPattern,
        ...
        {
            return System.IO.Directory.GetParent(directoryPath).FullName;
        }
