...
namespace Inovatiqa.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static Address ToAdminAddressEntity(this Inovatiqa.Web.Areas.Admin.Models.Common.AddressModel model, bool trimFields = true)
        {
            if (model == null)
                return null;

            var entity = new Address();
            return ToAdminAddressEntity(model, entity, trimFields);
        }
        ...
        public static Address ToAdminAddressEntity(this Inovatiqa.Web.Areas.Admin.Models.Common.AddressModel model, Address destination, bool trimFields = true)
        {
            if (model == null)
                return destination;
