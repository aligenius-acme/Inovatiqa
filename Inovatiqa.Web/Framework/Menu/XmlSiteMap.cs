...
namespace Inovatiqa.Web.Framework.Menu
{
    public class XmlSiteMap
    {
        ...
        {
            var filePath = Path.GetFullPath(physicalPath);
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            var inovatiqaResource = GetStringValueFromAttribute(xmlNode, "inovatiqaResource");
            siteMapNode.Title = inovatiqaResource;
