...
{
    public partial class OrderModel : BaseInovatiqaEntityModel
    {
        #region Ctor
        ...
        public partial class TaxRate : BaseInovatiqaModel
        {
            public string Rate { get; set; }
            public string Value { get; set; }
        }

        public partial class GiftCard : BaseInovatiqaModel
        {
        ...
        public partial class UsedDiscountModel: BaseInovatiqaModel
        {
    ...
    public partial class OrderAggreratorModel : BaseInovatiqaModel
    {
