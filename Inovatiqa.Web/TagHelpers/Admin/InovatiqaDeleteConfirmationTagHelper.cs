...
namespace Inovatiqa.Web.Framework.TagHelpers.Admin
{
    ...
    public class InovatiqaDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public InovatiqaDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
